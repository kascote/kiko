...
///
/// `renderAnchoredPopup` reports one through `Frame.report`, addressed to the
/// widget that owns the popup, when the placement it painted differs from the
/// standing decision it was handed. The owner's `update` stores it, and the
