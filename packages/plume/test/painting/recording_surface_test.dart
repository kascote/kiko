...
void main() {
  group('RecordingSurface', () {
    ...
    group('clip stack', () {
      test('pushNode intersects and popNode restores the previous clip', () {
        final surface = RecordingSurface<String>();
        expect(surface.clipRect, isNull);
        surface.pushNode(const Rect(0, 0, 10, 10));
        expect(surface.clipRect, const Rect(0, 0, 10, 10));
        surface.pushNode(const Rect(5, 5, 10, 10));
